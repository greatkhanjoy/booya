...
<div class="app-sidebar app-navigation app-navigation-fixed scroll app-navigation-style-default app-navigation-open-hover dir-left" data-type="close-other">
    ...
    <nav>
        <ul>
            ...
            <li><a href="{!! route('Dashboard') !!}"><span class="nav-icon-hexa text-bloody-100">Ds</span> Dashboard</a></li>
            <li>
                <a href="#"><span class="nav-icon-hexa text-orange-100">Us</span> Users</a>
                <ul>
                    <li><a href="{!! route('Users') !!}"><span class="nav-icon-hexa op">Au</span> All Users</a></li>
                    <li><a href="{!! route('Add new user') !!}"><span class="nav-icon-hexa">As</span> Add new user</a></li>
                    <li><a href="{!! route('Message') !!}"><span class="nav-icon-hexa">Ms</span> Send Message</a></li>
