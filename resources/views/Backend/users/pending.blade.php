  ...
  <div class="app-heading app-heading-bordered app-heading-page">
    <div class="row">
      ...
      <div class="col-md-8 text-right">
        ...
        <a href="{!! route('Users') !!}" type="button" class="btn btn-success"><span class="icon-smile"></span> Active users</a>
        <a href="{!! route('Deactive users') !!}" type="button" class="btn btn-info"><span class="icon-mustache"></span> Deactive users</a>
                  ...
                  @endphp
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <a href="javascript:void(0)"  data-toggle="modal" data-target="#modal-default{{ $user->id }}"  class="btn btn-warning btn-clean"><span class="icon-cross"></span> Delete</a>
                          <div class="col-md-4">
                          ...
                          <!-- MODAL DEFAULT -->
                          <div class="modal fade" id="modal-default{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-default-header">
